...
export default function Dashboard({ user, onLogout }) {
  ...
  return (
    <div className="container animate-fade-in" style={{ paddingBottom: '24px' }}>
      ...
      <div className="grid-2 delay-1 animate-fade-in" style={{ marginBottom: '24px' }}>
      ...
      <div className="grid-2 delay-2 animate-fade-in" style={{ marginBottom: '24px' }}>
